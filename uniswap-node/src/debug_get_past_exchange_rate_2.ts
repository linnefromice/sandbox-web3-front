...
import {POLYGON_POOLS, TOKEN_DECIMALS} from './constants';
...
// parameters
const csvFilePath = './data/data-blockNumber-polygon-hourly-202303.csv';
const outCsvFilePath =
  './data/data-exchangeRate-polygon-usdceth005-hourly-202303.csv';
const poolAddr = POLYGON_POOLS.usdc_eth_005;
const rpcUrl = providerUrl.polygon;
...
const mainGetPastExchangeRate2 = async () => {
